...
export function getMysteriousList(pageSize = 20, pageNum = 1, data) {
  var url = `center/user/mysterious/list?pageSize=${pageSize}&pageNum=${pageNum}`
...
export function updateStatus() {
  return request({
    url: 'center/user/mysterious/startMysteriousActivity',
    method: 'get'
