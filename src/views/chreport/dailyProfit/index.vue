<template>
  <div class="app-container">
    ...
    <el-table v-cloading="listLoading" :data="list" size="mini" fit highlight-current-row show-summary
      ...
      <el-table-column prop="boundAmt" min-width="120" label="红利" />
...
<script>
import { dailyProfit, liveProfitTotal } from '@/api/chreport/dailyProfit'
import mixin from '../mixin'
import { getDateTime } from '@/utils/tools'
const { NOW_TIME_START, NOW_TIME_END } = getDateTime()
export default {
  name: 'ChReportDailyProfitIndex',
  data() {
    return {
      list: [],
      listLoading: true,
