<template>
  <div class="app-container">
    ...
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-tag type="primary">当前活动状态:{{ message || '未开启' }}</el-tag>
      </el-form-item>
    ...
    >
      ...
      />
      <!-- <el-table-column prop="goldCoin" label="昨日彩票总派彩" min-width="50"   /> -->
      ...
      <!--  <el-table-column prop="kyCodeString" label="昨日彩票总派彩" min-width="50"   /> -->
...
import {
  getRecordList,
  getTotalList,
  getlottery_BET_seeial,
  stopLottery_BET_seeial,
  startHandsel,
  lottery_BET_seeial,
  stopHandsel,
  getCash_feedback,
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.message = null;
      getlottery_BET_seeial().then((res) => {
        if (
          res.data != null &&
          res.data != undefined &&
      ...
      getTotalList(
        ...
        .then((res) => {
          this.list = (res.data.list || []).map((item) => {
            ...
            /* var cpCodeString = item.cpCode.toLocaleString();
            var goldCoinString = item.goldCoin.toLocaleString(); */
            this.$set(item, "goldCoinString", typeString);
            this.$set(item, "cpCodeString", typeString);
