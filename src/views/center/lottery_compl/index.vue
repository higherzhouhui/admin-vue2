<template>
  <div class="app-container">
    ...
    >
      ...
      />
      <!-- <el-table-column prop="goldCoin" label="存款金额" min-width="50"   /> -->
...
import {
  getRecordList,
  getTotalList,
  getlottery_complacent_seeial,
  stopLottery_complacent_seeial,
  startHandsel,
  lottery_complacent_seeial,
  stopHandsel,
  getCash_feedback,
  stopWage_scale,
  startWage_scale,
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.message = null
      getlottery_complacent_seeial().then((res) => {
        if (
          res.data != null &&
          res.data != undefined &&
