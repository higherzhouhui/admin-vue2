<template>
  <div class="app-container">
    ...
    <el-form :inline="true">
      ...
      <br>
      <el-form-item v-if="message !== '已开启'">
        <el-button icon="el-icon-open" size="small" @click="handselStart()">开启活动</el-button>
      </el-form-item>
      <el-form-item v-else>
        <el-button icon="el-icon-turn-off" size="small" type="primary" @click="handselStop()">关闭活动</el-button>
      </el-form-item>
      <el-form-item>
        <el-tag type="primary">当前活动状态:{{ message || '已关闭' }}</el-tag>
      </el-form-item>
    </el-form>
    ...
    <el-table v-cloading="listLoading" :data="list" highlight-current-row size="mini">
      ...
      <el-table-column prop="sendUid" label="官方号" min-width="120" />
      <el-table-column prop="goldCoin" label="日存款金额" min-width="120" sortable />
      <!--  <el-table-column prop="userLevel" label="用户等级" min-width="50"   /> -->
      <el-table-column prop="cpCode" label="当日彩票流水" min-width="120" sortable />
      <!--   <el-table-column prop="agCode" label="AG流水" min-width="50"   /> -->
      <el-table-column prop="kyCode" label="开元流水" min-width="100" sortable />
      <!--  <el-table-column prop="fwCode" label="富翁流水" min-width="50"   />
 -->
      <el-table-column prop="typeString" label="活动类型" min-width="100" />

      <el-table-column prop="handsel" label="派送彩金" min-width="100" sortable />
    ...
    <el-table v-cloading="todayListLoading" :data="todayList" border size="mini">
      ...
      <el-table-column prop="" label="" min-width="60" />
      <el-table-column prop="totalCoin" label="总派彩金" min-width="60" />
      <el-table-column prop="" label="" min-width="60" />
      <el-table-column prop="" label="" min-width="60" />
