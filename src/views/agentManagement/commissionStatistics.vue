...
<script>
import {
  commissionModifyStatisTable,
  commissionModifyStatisExport
...
export default {
  name: 'AgentManagementCommissionStatistics',
  data() {
    return {
      list: [],
      todayList: null,
  ...
  methods: {
    ...
    handleDownload() {
      ...
      commissionModifyStatisExport(this.listQuery) // 导出的接口
        .then((result) => {
