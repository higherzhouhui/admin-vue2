...
<script>
import {
  giftCommissionStatisTable,
  giftCommissionStatisExport
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      giftCommissionStatisTable(this.listQuery)
        .then((res) => {
    ...
    handleDownload() {
      ...
      giftCommissionStatisExport(this.listQuery) // 导出的接口
        .then((result) => {
