      ...
      <el-table-column label="操作" width="160"  >
        <template slot-scope="{ row }">
          ...
          <el-button
            ...
            type="danger"
            size="mini"
            @click="checkUserRefuseClick(row)"
            >驳回</el-button
          >
        </template>
      </el-table-column>
...
<script>
import {
  getPromotionExchangeLogList,
  checkStatus,
  getPromotionExchangeLog,
} from "@/api/promotion/exchange_log";
import { emptyS, nullS, formatUnixTime } from "@/utils/tools";
import UserDrawer from "@/components/UserDrawer";

export default {
  name: "PromotionExchangeLogPage",
  filters: {},
  components: {
    UserDrawer,
  },
    ...
    fetchData() {
      ...
      getPromotionExchangeLog(
        ...
        .then((res) => {
          ...
          return getPromotionExchangeLogList(
            this.listQuery.limit,
            this.listQuery.page,
            this.listQuery
          );
