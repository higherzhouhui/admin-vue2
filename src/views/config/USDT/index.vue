<template>
  <div class="app-container">
    ...
    >
      <div v-cloading="dialogCreateLoading" style="width: 100%; height: 700px; overflow: auto; padding-right: 10px;">
        <el-form
          ref="dataForm"
          :model="createModel"
          :rules="rules"
        ...
        >
          ...
          ><el-input
            ...
            maxlength="200"
          /></el-form-item>
          <el-form-item label="USDT协议类型" prop="bankName">
            <el-select
              v-model="createModel.bankName"
              placeholder="请选择USDT协议类型"
            >
              <el-option
...
export default {
  ...
  data() {
    return {
      ...
      typeOptions: [{ value: 29, label: 'USDT' }],
      // 验证规则
      rules: {
        cardNo: [
          { required: true, message: '请输入USDT收款地址', trigger: 'change' },
          { min: 1, max: 200, message: '最多为200个字符', trigger: 'change' }
        ],
        bankName: [
          { required: true, message: '请选择USDT协议类型', trigger: 'change' },
