      ...
      <el-form-item label="日榜第一奖励的金币">
        <div style="display: flex;">
          <el-input
            ...
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayFirstCoinState = 1">编辑</el-button>
        </div>
      </el-form-item>

      <el-form-item label="日榜第二、三奖励的金币">
        <div style="display: flex;">
          <el-input
            v-model="configModel.daySecondCoin"
            :disabled="configModel.daySecondCoinState === 0 ? true : false"
            placeholder="请输入日榜第二、三奖励的金币"
            clearable
            maxlength="100"
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.daySecondCoinState = 1">编辑</el-button>
        </div>
      </el-form-item>
      ...
      <el-form-item label="日榜第4-10奖励的金币">
        <div style="display: flex;">
          <el-input
            ...
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayTenCoinState = 1">编辑</el-button>
        </div>
      </el-form-item>
      ...
      <el-form-item label="日榜第11-20奖励的金币">
        <div style="display: flex;">
          <el-input
            ...
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayTwentyCoinState = 1">编辑</el-button>
        </div>
      </el-form-item>
      ...
      <el-form-item label="日榜第21-50奖励的金币">
        <div style="display: flex;">
          <el-input
            ...
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayFiftyCoinState = 1">编辑</el-button>
        </div>
      </el-form-item>

      <el-form-item label="日榜第一奖励需要的流水" prop="dayFirstRank">
        <div style="display: flex;">
          <el-input
            v-model="configModel.dayFirstRank"
            :disabled="configModel.dayFirstRankState === 0 ? true : false"
            placeholder="请输入日榜第一奖励需要的流水"
            clearable
            maxlength="100"
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayFirstRankState = 1">编辑</el-button>
        </div>
      </el-form-item>
      <el-form-item label="日榜第二、三奖励需要的流水">
        <div style="display: flex;">
          <el-input
            v-model="configModel.daySecondRank"
            :disabled="configModel.daySecondRankState === 0 ? true : false"
            placeholder="请输入日榜第二、三奖励需要的流水"
            clearable
            maxlength="100"
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.daySecondRankState = 1">编辑</el-button>
        </div>
      </el-form-item>
      <el-form-item label="日榜第4-10奖励需要的流水">
        <div style="display: flex;">
          <el-input
            v-model="configModel.dayTenRank"
            :disabled="configModel.dayTenRankState === 0 ? true : false"
            placeholder="请输入日榜第4-10奖励需要的流水"
            clearable
            maxlength="100"
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayTenRankState = 1">编辑</el-button>
        </div>
      </el-form-item>
      <el-form-item label="日榜第11-20奖励需要的流水">
        <div style="display: flex;">
          <el-input
            v-model="configModel.dayTwentyRank"
            :disabled="configModel.dayTwentyRankState === 0 ? true : false"
            placeholder="请输入日榜第11-20奖励需要的流水"
            clearable
            maxlength="100"
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayTwentyRankState = 1">编辑</el-button>
        </div>
      </el-form-item>
      <el-form-item label="日榜第21-50奖励需要的流水">
        <div style="display: flex;">
          <el-input
            v-model="configModel.dayFiftyRank"
            :disabled="configModel.dayFiftyRankState === 0 ? true : false"
            placeholder="请输入日榜第21-50奖励需要的流水"
            clearable
            maxlength="100"
            show-word-limit
          />
          <el-button plain style="margin-left: 20px;" type="primary" @click="configModel.dayFiftyRankState = 1">编辑</el-button>
        </div>
      </el-form-item>
...
<script>
import { updateDayRank, getDayRank } from '@/api/config/coin'
