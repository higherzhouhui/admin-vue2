    ...
    >
      ...
      <el-table-column label="主播ID" min-width="80"  >
        <template slot-scope="{ row }">
          <user-drawer :uid="row.uid" :jumps="true" />
        </template>
      </el-table-column>
      <el-table-column
        prop="nickname"
...
<script>
import { getRankList, searchExport } from "@/api/live/rank";
...
export default {
  ...
  methods: {
    ...
    handleDownload() {
      ...
      searchExport(this.listQuery) //导出的接口
        .then((result) => {
