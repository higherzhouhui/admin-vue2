<template>
  <div class="app-container">
    ...
    <el-table v-cloading="listLoading" :data="list" size="mini">
      ...
      <el-table-column prop="currency" label="帮别代码" min-width="100" />
      <el-table-column prop="webId" label="站台代码" min-width="100" />
      <el-table-column prop="userId" label="会员唯一辨别码" min-width="120" />
      <el-table-column
        prop="sequenNumber"
        label="游戏记录唯一编号"
        width="120"
      />
      <el-table-column prop="gameId" label="游戏代码" min-width="100" />
      <el-table-column prop="subGameType" label="子游戏代码" min-width="100" />
      <el-table-column prop="betAmt" label="下注" width="100" />
      <el-table-column prop="winAmt" label="赢分" width="100" />
      <el-table-column prop="playTime" label="游戏时间" min-width="150" />
      <el-table-column
        prop="jackpotWinSum"
        label="jackpot贡献值"
        min-width="100"
...
<script>
import { recordRsg } from "@/api/platformGameRecord/rsgElectronics";
...
export default {
  name: "platformGameRecordRsgElectronicsIndex",
  components: {
    UserDrawer,
  },
  data() {
  ...
  methods: {
    ...
    fetchData() {
      this.listLoading = true;
      this.familyList = [];
      recordRsg(this.listQuery.limit, this.listQuery.page, this.listQuery)
        .then((res) => {
