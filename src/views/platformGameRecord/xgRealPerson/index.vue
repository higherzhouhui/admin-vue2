<template>
  <div class="app-container">
    ...
    <el-table v-cloading="listLoading" :data="list" size="mini">
      ...
      <el-table-column prop="wagersId" label="注单编号" min-width="100" />
      <el-table-column prop="gameId" label="游戏代号" min-width="100" />
      <el-table-column prop="betAmount" label="下注金额" width="100" />
      <el-table-column prop="validBetAmount" label="有效金额" min-width="100" />
      <el-table-column prop="wagersTime" label="下注时间" width="100" />
      <el-table-column prop="payoffAmount" label="输赢" width="100" />
      <el-table-column prop="commission" label="退水" min-width="100" />
      <el-table-column prop="jackPot" label="奖金" min-width="100" />
      <el-table-column prop="status" label="状态" min-width="100">
        <template slot-scope="{ row }">
          {{ statusF(row.status) }}
        </template>
      </el-table-column>
      <el-table-column prop="contribution" label="贡献金" min-width="100" />
      <el-table-column prop="gameCategoryId" label="游戏类型" min-width="100">
        <template slot-scope="{ row }">
          {{ gameCategoryIdF(row.gameCategoryId) }}
        </template>
      </el-table-column>

      <el-table-column prop="currency" label="帮别" min-width="120" />
      <el-table-column prop="gameMethod" label="游戏玩法" width="100" />

      <el-table-column prop="tableType" label="桌檯類型" width="100" />
      <el-table-column prop="tableId" label="游戏局桌檯ID" width="100" />
      <el-table-column prop="round" label="编号" width="100" />
      <el-table-column prop="run" label="局号(依每局结束更改)" width="140" />
      <el-table-column prop="gameResult" label="开牌结果" width="140" />
      <el-table-column prop="startTime" label="开始时间" width="140" />
      <el-table-column prop="endTime" label="结束时间" width="140" />
      <el-table-column prop="timeZoneName" label="时区" width="140" />
    </el-table>
...
<script>
import { recordXg } from "@/api/platformGameRecord/xgRealPerson";
