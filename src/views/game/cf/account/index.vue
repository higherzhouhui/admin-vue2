     ...
     >
      ...
      <el-table-column label="操作" width="160"  >
        <template slot-scope="{ row }">
          ...
          <!--          <el-button plain type="primary" size="mini" @click="showDownDialogClick(row)">下分</el-button>-->
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { getAccountList, autoUp } from "@/api/game/cf/account";
import { formatUnixTime } from "@/utils/tools";

export default {
  name: "CfGameAccountController",
  filters: {
    statusFilter(status) {
